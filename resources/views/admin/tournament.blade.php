                    ...
                    <div class="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
                        ...
                        <div class="overflow-x-auto max-h-64 overflow-y-auto">
                            <table class="min-w-full text-sm">
                                <thead><tr class="text-left border-b"><th class="p-2">Rank</th><th class="p-2">User</th><th class="p-2">Points</th><th class="p-2">Eliminated</th><th class="p-2"></th></tr></thead>
                                <tbody>
